...
export interface NavItem {
  label: string;
  /** Bangla label, present only for items sourced from the CMS menu builder. */
  labelBn?: string;
  href: string;
...
export const mainNav: NavItem[] = [
...

  {
    ...
    children: [
      {
        label: "Permission Recognition Letter",
        href: "/information/permission-recognition-letter",
        section: "information",
        slug: "permission-recognition-letter",
      },
      {
        label: "Nationalization",
        href: "/information/nationalization",
        section: "information",
        slug: "nationalization",
      },
      {
        label: "Statistics Report",
        href: "/information/statistics-report",
        section: "information",
        slug: "statistics-report",
      },
      {
        label: "Govt. Approval Letter",
        href: "/information/govt-approval-letter",
        section: "information",
        slug: "govt-approval-letter",
      },
    ],
  },
...

  {
    ...
    children: [
      ...
      {
        label: "Tuition Fees",
        href: "/student/tuition-fees",
        section: "student",
        slug: "tuition-fees",
      },
      {
        label: "Mobile Banking",
        href: "/student/mobile-banking",
        section: "student",
        slug: "mobile-banking",
      },
      {
        label: "Daily Activities",
        href: "/student/daily-activities",
        section: "student",
...

  {
    ...
    children: [
      ...
      {
        label: "Physics Lab",
        href: "/facilities/physics-lab",
        section: "facilities",
        slug: "physics-lab",
      },
      {
        label: "Biology Lab",
        href: "/facilities/biology-lab",
        section: "facilities",
        slug: "biology-lab",
      },
      ...
      {
        label: "Chemistry Lab",
        href: "/facilities/chemistry-lab",
        section: "facilities",
        slug: "chemistry-lab",
      },
      {
        label: "Extra Activities",
        href: "/facilities/extra-activities",
        section: "facilities",
        slug: "extra-activities",
      },
    ],
  },

  {
    ...
    children: [
      { label: "Exam Result", href: "/result/exam-result", section: "result", slug: "exam-result" },
      {
        ...
        href: "/result/academic-result",
        section: "result",
        slug: "academic-result",
      },
      {
        label: "Evaluation Result",
        href: "/result/evaluation-result",
        section: "result",
        slug: "evaluation-result",
      },
      {
        label: "Board Exam Result",
        href: "/result/board-exam-result",
        section: "result",
        slug: "board-exam-result",
      },
    ],
  },
...
export const allRoutes: { href: string; section: string; slug?: string; label: string }[] =
